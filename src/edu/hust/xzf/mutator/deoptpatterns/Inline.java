...
public class Inline extends MutateTemplate {
    ...
    public static int locateNewMethod(ITree tree) {
    ...
    */
    ...
    public void generatePatches() {
        ...
        if (Checker.isNumberLiteral(type)) {
            ...
            isInlined = newM;
            importPos1 = locateNewMethod(select);
    ...
    public String doPostProcess(String patchedJavaFile) {
        ...
        return patchedJavaFile.substring(0, importPos1)
                + isInlined + patchedJavaFile.substring(importPos1);
    }
}
