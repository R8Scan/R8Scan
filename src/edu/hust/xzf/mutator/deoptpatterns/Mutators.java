...
import edu.hust.xzf.mutator.synthesize.Synthesizer;
...
public enum Mutators {
    ...
    verticalClassMerger {
        ...
        public VerticalClassMerger createInstance() {
            return new VerticalClassMerger();
        }
    }, // 垂直类合并
    ...
    synthesizer {
        ...
        public Synthesizer createInstance() {
